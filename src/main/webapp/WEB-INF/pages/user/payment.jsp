...
<div class="product-detail-container">
    <div class="grid">
        <div class="grid__row">
            ...
            <form:form action="/payment" modelAttribute="paymentCart" method="post" >
                <div class="checkout-content">
                    ...
                    <div class="checkout-left">
                        ...
                        <div class="credit-cart">
                            <span class="checkout-heading__text pt-10">ENTER YOUR CARD INFORMATION</span>
                            <div class="form-checkout">
                                <div class="form-input">
                                    <input type="text" name="fullName" value="${customer.fullName}" class="input-control__login" placeholder=" ">
                                    <label class="form__label">Full Name</label>
                        ...
                        <div class="checkout-right__main">
                            <div class="checkout-main__heading">
                                ...
                                <div class="checkout-btn-payment">
                                    <a href="" class=" btn-default_detail btn--payment ">
                                        <i class="fas fa-shipping-fast detail-cart_icon"></i>
                                        Payment on delivery</a>
